...
#endif	
	v = 0x00ff00ff;
	writel_relaxed(v, RK_GRF_VIRT + RK3288_GRF_GPIO1D_E);
...
static int rk3288_lcdc_post_cfg(struct rk_lcdc_driver *dev_drv)
{
	...
	printk("post:xsize=%d,ysize=%d,xpos=%d,ypos=%d,"
	...
	printk("--->yzq post_dsp_vact_st=%d post_dsp_vact_end=%d\n",post_dsp_hact_st, post_dsp_hact_end);
